...
BEGIN
    ...
    -- Generate a new report id by incrementing the maximum report id found in sales_reports table
...
-- Create an event to generate the sales report every month
...
BEGIN
    ...
    -- Generate a new report id by incrementing the maximum report id found in quantity_ordered_reports table
...
-- CALL generate_quantity_ordered_report(2024,9);
