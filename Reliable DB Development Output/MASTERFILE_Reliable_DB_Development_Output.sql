-- -----------------------------------------------------
-- Start of Original DB Sales Sql Script
-- -----------------------------------------------------
CREATE DATABASE  IF NOT EXISTS `dbsales` /*!40100 DEFAULT CHARACTER SET latin1 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `dbsales`;
...
CREATE TABLE `customers` (
  ...
  KEY `FK0003_idx` (`salesRepEmployeeNumber`),
  CONSTRAINT `FK0003` FOREIGN KEY (`salesRepEmployeeNumber`) REFERENCES `employees` (`employeeNumber`)
...
CREATE TABLE `employees` (
  ...
  KEY `FK0005_idx` (`officeCode`),
  KEY `FK0006_idx` (`reportsTo`),
  CONSTRAINT `FK0005` FOREIGN KEY (`officeCode`) REFERENCES `offices` (`officeCode`),
  CONSTRAINT `FK0006` FOREIGN KEY (`reportsTo`) REFERENCES `employees` (`employeeNumber`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `orderdetails` (
  ...
  CONSTRAINT `FK0001` FOREIGN KEY (`orderNumber`) REFERENCES `orders` (`orderNumber`),
  CONSTRAINT `FK0008` FOREIGN KEY (`productCode`) REFERENCES `products` (`productCode`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `products` (
  ...
  KEY `FK0009_idx` (`productLine`),
  CONSTRAINT `FK0009` FOREIGN KEY (`productLine`) REFERENCES `productlines` (`productLine`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-09-25 11:04:44
-- -----------------------------------------------------
-- End of Original DB Sales Sql Script
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Start of Creating Extended DB Sales Sql Script
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- End of Creating Extended DB Sales Sql Script
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Start of DBSales Migration Script 
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- End of DBSales Migration Script 
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Start of Extended DB Sales Access Script
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- End of Extended DB Sales Access Script
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Start of Creating Audit Facility in Extended DB Sales Script
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- End of Creating Audit Facility in Extended DB Sales Script
-- -----------------------------------------------------


-- -----------------------------------------------------
-- Start of Creating Triggers to Implement Business Rules Script
-- -----------------------------------------------------
...
DELIMITER ;
-- -----------------------------------------------------
-- End of Creating Triggers to Implement Business Rules Script
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Start of Creating Stored Functions Script
-- -----------------------------------------------------
...
DELIMITER ;
-- -----------------------------------------------------
-- End of Creating Stored Functions Script
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Start of Generating Regular Reports Script
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- End of Generating Regular Reports Script
-- -----------------------------------------------------